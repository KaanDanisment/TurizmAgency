...
public class AgencyGUI extends JFrame{
    ...
    public AgencyGUI(){
        ...
        entranceDateChooser.setDateFormatString("dd.MM.yy");
        ...
        releaseDateChooser.setDateFormatString("dd.MM.yy");
        ...
        bttn_search.addActionListener(e -> {
            Date entranceDate = entranceDateChooser.getDate();
            Date releaseDate = releaseDateChooser.getDate();
            ...
            if (entranceDate != null || releaseDate != null){
                ...
                if (isDatesEqual) {
                    ...
                    ReservasionGUI reservasionGUI = new ReservasionGUI(city,days,adultCount,childCount,entranceDateChooser,releaseDateChooser);
                }
            }else {
        ...
        bttn_hotel_add.addActionListener(e -> {
            AddingHotelGUI addingHotelGUI = new AddingHotelGUI();
            dispose();
        });


        bttn_add_room.addActionListener(e -> {
            AddingRoomGUI roomGUI = new AddingRoomGUI();
            dispose();
        });
